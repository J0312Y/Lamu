...
const releases = [
  {
    ...
    changes: [
      { type: 'new', text: 'Application web Lamu (webapp) — accedez a Lamu depuis votre navigateur' },
      { type: 'new', text: 'Systeme de licences par email — connexion sans cle, rebind automatique sur nouveau PC' },
      { type: 'new', text: 'Authentification OTP par email pour la webapp' },
      { type: 'new', text: 'Plans et tarification configurables depuis l\'admin SaaS' },
      { type: 'new', text: 'Essai gratuit avec 20 messages — aucune carte requise' },
      { type: 'new', text: 'Helpdesk IA — agents configurables avec seuil de confiance et escalade' },
      { type: 'new', text: 'Systeme de tickets avec suivi du sentiment et resolution automatique' },
      { type: 'new', text: 'Widget chat integrable sur site externe (snippet JS)' },
      { type: 'new', text: 'Workflows d\'escalade conditionnels (mot-cle, sentiment, nombre de reponses)' },
      { type: 'new', text: 'Deploiement multi-canal (website, Slack, Zendesk, email, WhatsApp, API)' },
      { type: 'new', text: 'Analytiques avancees — sentiments, sujets, taux de resolution auto' },
      { type: 'new', text: 'Gestion d\'equipe avec roles (membre, editeur, admin)' },
      { type: 'new', text: 'Integrations externes (Google Drive, Notion, Slack, Zendesk, HubSpot)' },
      { type: 'new', text: 'Simulation et tests — validez les reponses IA contre des reponses attendues' },
      { type: 'new', text: 'Detection des lacunes dans la base de connaissances (KB Gaps)' },
      { type: 'new', text: 'Tableau de bord avec statistiques d\'utilisation et historique de questions' },
      { type: 'new', text: 'Recherche semantique dans la base de connaissances depuis la webapp' },
      { type: 'new', text: 'Partage de conversations par lien public' },
      { type: 'improve', text: 'Interface entierement traduite en francais' },
      { type: 'improve', text: 'Theme clair et sombre avec basculement instantane' },
      { type: 'improve', text: 'Onboarding interactif avec suivi de progression en 3 etapes' },
      { type: 'improve', text: 'Synchronisation des conversations sur le serveur avec sauvegarde locale' },
      { type: 'security', text: 'Anti-reutilisation de licence — binding machine + expiration en base de donnees' },
      { type: 'security', text: 'Endpoint admin protege par cle API pour le transfert de licences' },
    ],
  },
  {
    version: '0.1.9',
    ...
    changes: [
      ...
      { type: 'improve', text: 'Temps de reponse IA optimise sans perte de contexte' },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'new', text: 'API developpeur compatible OpenAI' },
      { type: 'new', text: 'Support des modeles Google Gemini et Mistral' },
