  ...
  return (
    <>
      ...
      <Section title="1. Acceptation des conditions">
        <p>En téléchargeant, installant ou utilisant Lamu ("l'application"), vous acceptez les présentes conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser l'application.</p>
      </Section>
      <Section title="2. Licence d'utilisation">
        <p>Lamu est disponible en deux modes :</p>
      ...
      <Section title="4. Propriété intellectuelle">
        <p>Lamu et tous ses composants (code, design, marque) sont la propriété exclusive de Lamu. Toute reproduction, distribution ou utilisation commerciale est interdite sans autorisation écrite.</p>
      </Section>
      <Section title="5. Limitation de responsabilité">
        <p>Lamu est fourni "tel quel". Nous ne garantissons pas une disponibilité ininterrompue et déclinons toute responsabilité pour les pertes de données ou dommages indirects résultant de l'utilisation de l'application.</p>
      </Section>
    ...
    <>
      ...
      <Section title="1. Données collectées">
        ...
        <ul style={{ paddingLeft: 20, marginTop: 8 }}>
          ...
          <li style={{ marginBottom: 6 }}><strong style={{ color: '#fff' }}>Utilisation de l'app</strong> : Lamu fonctionne localement. Vos conversations sont stockées sur votre appareil (SQLite local), nous n'y avons pas accès.</li>
      ...
      <Section title="5. Cookies">
        <p>Le site web Lamu n'utilise pas de cookies de tracking. Aucune donnée analytique tierce (Google Analytics, etc.) n'est collectée.</p>
      </Section>
