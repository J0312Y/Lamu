...
const View = () => {
  ...
  const { isBlocked, supportsImages, hasPlanFeature } = useApp();
            ...
            <div className="select-none p-5 z-100 bg-primary/5 border border-primary/20 rounded-xl absolute top-4 left-4 right-4">
              <div className="max-w-sm mx-auto">
                <p className="text-sm font-medium text-center">
                  Your free trial has expired. Get a license to continue chatting.
                </p>
                <GetLicense
                  buttonText="Obtenir une licence"
              ...
              <>
                <div className="absolute bottom-2 left-2 flex items-center gap-1 z-10">
                  <ChatFiles
                    ...
                    disabled={(isBlocked && !hasPlanFeature("file_attachments")) || !supportsImages}
                  />
                  <ChatAudio
                    ...
                    disabled={isBlocked && !hasPlanFeature("audio_capture")}
                  />
                  <ChatScreenshot
                    ...
                    disabled={(isBlocked && !hasPlanFeature("screenshot")) || !supportsImages}
                  />
                </div>
                ...
                <Textarea
                  ...
                  disabled={completion.isLoading || isBlocked}
                />
                <Button
                  size="icon"
