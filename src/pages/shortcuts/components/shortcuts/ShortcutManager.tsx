...
export const ShortcutManager = () => {
  const { hasActiveLicense, isBlocked } = useApp();
  ...
  const loadShortcuts = () => {
    ...
    const allActions = getAllShortcutActions(!lamuApiBlocked);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            configured
            {lamuApiBlocked && " • Get a license to customize shortcuts"}
          </p>
        </div>
