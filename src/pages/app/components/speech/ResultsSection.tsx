...
import { BotIcon, HeadphonesIcon, Loader2, SparklesIcon, Volume2Icon, VolumeXIcon } from "lucide-react";
...
export const ResultsSection = ({
  ...
  // Stop speaking when response changes or processing starts
  useEffect(() => {
    if (isAIProcessing) {
        ...
        <div className="flex items-center gap-2 select-none">
          ...
          {lastAIResponse && (
            <>
              ...
              >
                {isSpeaking
                  ? <VolumeXIcon className="h-3 w-3 text-primary" />
