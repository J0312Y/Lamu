...
export const DragButton = () => {
  const { hasPlanFeature, isBlocked } = useApp();
  // During trial (or with a valid licence) users can drag; only blocked after trial expires
  const canDrag = hasPlanFeature("drag_window") || !isBlocked;
          ...
          <div className="flex flex-col gap-2 w-116">
            <div className="flex flex-col gap-1 pb-2">
              ...
              <p className="text-sm font-medium text-muted-foreground">
                ...
                via email. Paste in the Settings → Lamu Access section to
                activate.
              </p>
            </div>
  ...
  return (
    <Button
      ...
      data-tauri-drag-region={canDrag}
    >
      <GripVerticalIcon className="h-4 w-4" />
    </Button>
  );
