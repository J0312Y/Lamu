...
export interface UseCompletionReturn {
  ...
  /** Function to control conversation history panel visibility */
  setIsConversationHistoryOpen: Dispatch<SetStateAction<boolean>>;

  // DB agent
  dbResults: any[];
  pendingWrite: any | null;
  dbQueryLoading: boolean;
  confirmWriteQuery: (confirmed: boolean) => Promise<void>;
  clearDbResults: () => void;
  rerunQuery: (sql: string, integrationId: string, dbName: string) => Promise<void>;
  dbIntegrations: any[];
}
